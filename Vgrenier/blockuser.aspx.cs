...
WebConfigurationManager.ConnectionStrings["vigrenier"].ConnectionString;
        ...
        void getActiveUsers()
        {
            ...
            cmd.CommandText = "Select user_id, user_firstname, user_lastname, user_username,user_profilepicture from tbluser where user_status = 1";
            cmd.Connection = con;
        ...
        protected void lnkblock_Click(object sender, EventArgs e)
        {
            ...
            ucmd.CommandText = "update tblUser set user_status='0' where user_id = " + uid;
            ucmd.Connection = con;
